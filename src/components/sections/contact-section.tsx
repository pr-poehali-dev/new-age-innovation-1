        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="font-mono text-xs text-foreground/60 md:text-base">/ Будем рады общению</p>
            </div>

            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:info@russkie-derevya.ru"
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">Россия, от Калининграда до Камчатки</p>
              </div>
